...
#include "/home2/antonio/redneu_v7.2.5/babel_v6/random.hpp"
...
int main(int argc, const char* argv[]){
    ...
    A = rna.adecuacion(seqs[0], objetivo, delta);
    ...
    for(int t = 1; t < generaciones; ++t){
        ...
        for(int j = 0; j < n_mol; ++j){
            if(plegar[j] == 1){
                ...
                adec[j] = rna.adecuacion(seqs[j], objetivo, delta);
                free(st2);
                free_tree(T2);
            }
        }
    ...
    path = "/home2/antonio/redneu_v7.2.5/res/pt/";
